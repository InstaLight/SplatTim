...
class Splatoon:
    ...
    @commands.group(aliases=['sp1', 'splatoon1'], pass_context=True)
    ...
    @splat1.command(name='maps', aliases=['rotation'], pass_context=True)
    ...
    @splat1.command(name='schedule', pass_context=True)
    ...
    @splat1.command(name='weapon', pass_context=True)
    ...
    @splat1.command(name='scrim', pass_context=True)
    ...
    @splat1.command(name='brand', invoke_without_command=True, pass_context=True)
    ...
    @commands.command()
    async def salmonrun(self, ctx, pass_context=True):
    ...
    @commands.command(aliases=['splatnetshop'], pass_context=True)
    ...
    async def new_weapon(self, ctx, name, sub, special):
        ...
        if not ctx.message.author.id in self.bot.authors:
            pass
        weapons = self.splat2_data.get('weapons', [])
        entry = {
            'name': name,
